...
exports.corsRouter = (0, rnode_server_1.Router)();
// CORS middleware only for API routes
exports.corsRouter.use('/api', (req, res, next) => {
...
// Simple test route
exports.corsRouter.get('/api/test', (req, res) => {
    res.json({
        success: true,
...
exports.corsRouter.get('/api/cors-test', (req, res) => {
    try {
...
exports.corsRouter.get('/api/cookies', (req, res) => {
...
exports.corsRouter.delete('/api/cookies/{name}', (req, res) => {
...
exports.corsRouter.get('/api/cookies/info', (req, res) => {
...
exports.corsRouter.get('/api/helpers', (req, res) => {
