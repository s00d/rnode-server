...
const auth_database_1 = __importDefault(require("../auth-database"));
const authDb = new auth_database_1.default();
// Clean up expired sessions on startup
authDb.cleanupExpiredSessions();
exports.authApiRouter = (0, rnode_server_1.Router)();
// Global middleware for logging all requests and authorization
exports.authApiRouter.use((req, res, next) => {
...
exports.authApiRouter.post('/register', (req, res) => {
...
exports.authApiRouter.post('/login', (req, res) => {
...
exports.authApiRouter.post('/logout', (req, res) => {
...
exports.authApiRouter.get('/profile', (req, res) => {
...
exports.authApiRouter.get('/test-params', (req, res) => {
